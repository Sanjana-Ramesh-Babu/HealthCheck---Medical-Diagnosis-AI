...
# Redirect /templates/index.html to /index (handles incorrect direct access)
@app.get("/templates/index.html", response_class=RedirectResponse)
async def redirect_template_to_route():
